...
// TransferList.h : Contains reference counted transfers
...
public:
	...
	~TransferList();
	BOOL Init();
	BOOL RegisterTransfer(Transfer* lpTransfer);
	void PutTransfer(Transfer* lpTransfer);
	Transfer* GetTransfer(Transfer* lpTransfer);
